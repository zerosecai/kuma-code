...
export namespace LLM {
  ...
  const permissions = makeRuntime(Permission.Service, Permission.defaultLayer)
          ...
          if (language instanceof GitLabWorkflowLanguageModel) {
            ...
            workflowModel.approvalHandler = Instance.bind(async (approvalTools) => {
              ...
              try {
                ...
                await permissions.runPromise((svc) =>
                  svc.ask({
                    id,
          ...
          Stream.scoped(
            Stream.unwrap(
              Effect.gen(function* () {
                ...
                return Stream.fromAsyncIterable(result.fullStream, (err) =>
