...
# Using v0 With Kuma Code

Kuma Code supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with Kuma Code through the familiar OpenAI API interface.

## Prerequisites

To use v0 with Kuma Code, you'll need:
...
Setting up v0 in Kuma Code is straightforward:

1. In Kuma Code settings (click the {% codicon name="gear" /%} icon):
...
<!-- <img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in Kuma Code settings" width="600" /> -->
