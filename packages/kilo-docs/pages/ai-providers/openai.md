...
# Using OpenAI With Kuma Code

Kuma Code supports accessing models directly through the official OpenAI API.
...
3.  **Create a Key:** Click "Create new secret key". Give your key a descriptive name (e.g., "Kuma Code").
