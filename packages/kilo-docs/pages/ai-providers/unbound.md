...
2.  **Create an Application:** Go to the [Connect](https://gateway.getunbound.ai/connect) page and select "Kuma Code".
3.  **Copy the API Key:** Copy the API key to your clipboard.

## Supported Models

Unbound allows you configure a list of supported models in your application, and Kuma Code will automatically fetch the list of available models from the Unbound API.
...
Unbound is not yet available as a CLI provider. Check the [Kuma Code releases](https://github.com/Kilo-Org/kuma-code/releases) for updates on provider support.
{% /callout %}
