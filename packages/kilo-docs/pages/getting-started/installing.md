---
title: "Installation"
description: "How to install Kuma Code on your system"
---

# Installation

Get started with Kuma Code by installing it on your preferred platform. Choose your development environment below:
...
The current Kuma Code extension is built on the [Kilo CLI](https://github.com/Kilo-Org/kuma-code) and is distributed as the **pre-release version** on the VS Code Marketplace.
...
The legacy extension is the previous version of Kuma Code for VS Code. It is still available but is no longer actively developed. We recommend installing the current extension (see the **VS Code** tab).
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [Kuma Code page on Open VSX Registry](https://open-vsx.org/extension/kuma-code/Kilo-Code).
...
4. Search for "Kuma Code"
5. Select "Kuma Code" and click **Install**
...
1. **Download the VSIX file:**
   - Find official releases on the [Kuma Code GitHub Releases page](https://github.com/Kilo-Org/kuma-code/releases)
   - Download the `.vsix` file from the [latest release](https://github.com/Kilo-Org/kuma-code/releases/latest)
...
1. Open the [Kuma Code GitHub Releases page](https://github.com/Kilo-Org/kuma-code/releases)
...
{% image src="/docs/img/installing-vsix.png" alt="Installing Kuma Code using VS Code's Install from VSIX dialog" width="600px" caption="Installing Kuma Code using VS Code's \"Install from VSIX\" dialog" /%}
...
- Restart VS Code
- Verify Kuma Code is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "Kuma Code")
...
- [Your First Task](/docs/code-with-ai/agents/chat-interface) - Learn the basics of working with Kuma Code
...
- Submit issues on [GitHub](https://github.com/Kilo-Org/kuma-code/issues)
- Visit our [Reddit community](https://www.reddit.com/r/KumaCode)
