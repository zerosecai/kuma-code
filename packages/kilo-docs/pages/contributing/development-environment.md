...
{% callout type="info" %}
**New versions of the VS Code extension and CLI are being developed in [Kilo-Org/kuma-code](https://github.com/Kilo-Org/kuma-code)** (extension at `packages/kilo-vscode`, CLI at `packages/opencode`). For extension and CLI development, please head over to that repository.
{% /callout %}
...
1. **Fork and Clone the Repository**:
   - **Fork the Repository**:
     - Visit the [Kuma Code GitHub repository](https://github.com/Kilo-Org/kuma-code)
     - Click the "Fork" button in the top-right corner to create your own copy.
   - **Clone Your Fork**:
     ```bash
     git clone https://github.com/[YOUR-USERNAME]/kuma-code.git
     cd kuma-code
     ```
...
2. This will open a new VSCode window with Kuma Code loaded
...
Kuma Code uses several types of tests to ensure quality:
...
- Check the Output panel in VSCode (View > Output) and select "Kuma Code" from the dropdown
