...
description: "Community-maintained resources and projects that work with Kuma Code"
---

# Community Projects

This page highlights community-driven resources that are relevant for Kuma Code users.
...
- **[Kuma Code Show and Tell Discussions](https://github.com/Kilo-Org/kuma-code/discussions/categories/show-and-tell)**  
  Real examples from users building workflows with Kuma Code.
...
2. Clear setup instructions for Kuma Code or MCP
3. License terms appropriate for your use case
4. Security posture (dependency hygiene, least-privilege permissions)

## Share Your Project

Built something useful with Kuma Code?  
Share it in [Show and Tell](https://github.com/Kilo-Org/kuma-code/discussions/categories/show-and-tell) or contribute it to the [Kilo Marketplace](https://github.com/Kilo-Org/kilo-marketplace).
