...
Generate descriptive commit messages automatically based on your staged git changes. Kuma Code analyzes your staged files and creates conventional commit messages that follow best practices.
...
2. In the VS Code Source Control panel, look for the `Kuma Code` logo next to the commit message field)
...
- [Settings Management](/docs/getting-started/settings) - Manage all your Kuma Code preferences
