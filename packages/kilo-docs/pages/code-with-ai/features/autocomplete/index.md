---
title: "Autocomplete"
description: "AI-powered code autocompletion in Kuma Code"
---

# Autocomplete

Kuma Code's autocomplete feature provides intelligent code suggestions and completions while you're typing, helping you write code faster and more efficiently. It offers both automatic and manual triggering options.
...
The extension automatically detects if **GitHub Copilot** inline suggestions are enabled and warns you about potential conflicts. Disable Copilot's inline completions for the best experience with Kuma Code autocomplete.
...
When enabled, Kuma Code automatically shows inline suggestions when you pause typing. This provides a seamless coding experience where suggestions appear naturally as you work.
...
3. Kuma Code analyzes the surrounding context
...
When enabled, Kuma Code will suggest completions as you type in the chat input. Press Tab to accept suggestions.
...
Kuma Code automatically selects a provider for autocomplete in the following priority order:

- **Mistral** (using `codestral-latest`)
- **Kuma Code** (using `mistralai/codestral-2508`)
...
We recommend disabling rival autocompletes to optimize your experience with Kuma Code. To disable GitHub Copilot autocomplete in VSCode, go to **Settings** and navigate to **GitHub** > **Copilot: Advanced** (or search for 'copilot').
