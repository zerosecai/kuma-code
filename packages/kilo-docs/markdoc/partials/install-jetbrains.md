Kuma Code supports all JetBrains IDEs including IntelliJ IDEA, WebStorm, PyCharm, and more.

### Prerequisites

Before installing the Kuma Code plugin, ensure you have:
...
2. Then, you can click the button below to install Kuma Code directly from the JetBrains Marketplace:

[![Install Kuma Code](https://raster.shields.io/badge/Install%20Kilo%20Code-F8F674?style=for-the-badge)](https://plugins.jetbrains.com/plugin/28350-kilo-code)
